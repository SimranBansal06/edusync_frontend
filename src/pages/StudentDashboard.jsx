...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE_URL}/CourseModels`).then((res) => {
      setCourses(res.data);
      ...
      const instructorPromises = enrolled.map((course) => {
        ...
        if (instructorId) {
          return axios
            .get(`${API_BASE_URL}/UserModels/${instructorId}`)
            .then((instructorRes) => {
              return {
            ...
            .catch((err) => {
              console.error(
                `Error fetching instructor for course ${
      ...
      Promise.all(instructorPromises).then((instructorResults) => {
      ...
      enrolled.forEach((course) => {
        ...
        axios.get(`${API_BASE_URL}/AssessmentModels`).then((assessmentRes) => {
    ...
    axios.get(`${API_BASE_URL}/ResultModels`).then((res) => {
      setResults(
        res.data.filter(
          (r) =>
                ...
                <div key={courseId} className="course-card">
                  ...
                  <div className="course-actions">
                    ...
                    <button
                      ...
                      className={`btn ${
                        hasAssessments ? "btn-primary" : "btn-disabled"
                      }`}
