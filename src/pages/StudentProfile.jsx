  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response) {
        ...
        setError(
          "Network error: The server did not respond. Please check your connection."
        );
      } else {
            ...
            <div className="profile-sidebar">
              ...
              <div className="sidebar-actions">
                ...
                <button
                  ...
                  className="sidebar-btn password"
                >
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const studentResults = resultsResponse.data.filter(
                      (result) => (result.userId || result.UserId) === studentId
                    );
                    console.log(
                      `Found ${studentResults.length} results for this student to delete`
                    );
                    ...
                    await axios.delete(
                      `${API_BASE_URL}/UserModels/${studentId}`,
                      {
                        headers: {
                          Authorization: `Bearer ${token}`,
                          "Content-Type": "application/json",
