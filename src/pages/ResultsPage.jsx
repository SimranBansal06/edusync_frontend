...
const ResultsPage = () => {
  ...
  useEffect(() => {
    // If no state is available, try to get it from sessionStorage
    if (!state) {
      const savedResults = sessionStorage.getItem("assessmentResults");
      if (savedResults) {
        const parsedResults = JSON.parse(savedResults);
        // Replace the current location with the same path but with the state
        ...
        <div className="results-main">
          ...
          <div className="review-section">
            ...
            <p className="review-instructions">
              Review your answers to understand what you got right and where you
              need improvement.
            </p>
