  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setCourses(
          res.data.filter(
            (c) => String(c.instructorId || c.InstructorId) === String(uid)
          )
        );
      })
    ...
    <div className="assessment-form-container">
      ...
      <form className="assessment-form" onSubmit={handleSubmit}>
        ...
        >
          ...
          {courses.map((c) => (
            <option
              key={c.courseId || c.CourseId}
              value={c.courseId || c.CourseId}
            >
              {c.title || c.Title}
            </option>
          ))}
        ...
        <div className="questions-section">
          <h3 style={{ marginBottom: 24, color: "#243047", fontWeight: 700 }}>
            Questions
          </h3>
